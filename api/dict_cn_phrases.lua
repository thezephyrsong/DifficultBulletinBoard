...
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "来T%s?N", en = "need Tank or Healer " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "来个T%s?N", en = "need Tank or Healer " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "来T", en = "need Tank " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "来N", en = "need Healer " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "来DPS", en = "need DPS " }
...
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "诺莫瑞根任务队", en = "Gnomeregan quest group " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "霜鬃谷任务队", en = "Frostmane Hollow quest group " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "监狱任务队", en = "Stockades quest group " }
dict_cn_phrases[table.getn(dict_cn_phrases)+1] = { cn = "诺莫瑞根任务队", en = "Gnomeregan quest group " }
